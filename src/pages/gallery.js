...
class Gallery extends React.Component {
    ...
    <div className="row">
        <section className="section row g-0 p-0 gallery">
            ...
            <div className="col-12 col-lg-6 align-self-center gallery-infomation">
                <h2>2D BLACK &amp; WHITE 
                    <span className="inlineSummary fs-5 text-primary d-block"><span className="priceBlock">Php300.00 </span>
                    </span>
                </h2>
        ...
        <div className="col-12 col-lg-6 align-self-center gallery-infomation">
            ...
            <span className="priceBlock">Php 300.00</span>
            </span>
            </h2>
    ...
    <section className="section row g-0 p-0 gallery">
        ...
        <div className="col-12 col-lg-6 align-self-center gallery-infomation">
            ...
            <span className="priceBlock">Php 300.00 PER STORY</span>
            </span>
            </h2>
